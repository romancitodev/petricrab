...
mod tests {
  ...
  fn transition_disabled_until_enough_tokens() {
    ...
    net
      .add_arc_place_to_transition(p, t, ArcKind::Consume(2))
      .unwrap();
  ...
  fn fire_in_does_not_mutate_original_marking() {
    ...
    let t = net.add_transition("t");
    net
      .add_arc_place_to_transition(p_in, t, ArcKind::Consume(1))
      .unwrap();
  ...
  fn peek_arc_requires_tokens_but_does_not_consume() {
    ...
    let t = net.add_transition("t");
    net
      .add_arc_place_to_transition(guard, t, ArcKind::Peek(1))
      .unwrap();
  ...
  fn inhibit_arc_blocks_when_tokens_present() {
    ...
    let t = net.add_transition("t");
    net
      .add_arc_place_to_transition(guard, t, ArcKind::Inhibit(1))
      .unwrap();
