...
mod tests {
    ...
    fn add_place_and_transition_with_arcs_tracks_tokens_and_marking() {
        ...
        net.add_arc_place_to_transition(p1, t, ArcKind::Consume(2))
            .unwrap();
    ...
    fn remove_arc_deletes_only_matching_arc() {
        ...
        let p2 = net.add_place("p2");
        let t = net.add_transition("t");
        net.add_arc_place_to_transition(p1, t, ArcKind::Consume(1))
            .unwrap();
        net.add_arc_place_to_transition(p2, t, ArcKind::Consume(1))
            .unwrap();
